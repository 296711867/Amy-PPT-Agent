...
export const en = {
  ...
  generationNotifications: {
    ...
    paused: '"{title}" generation paused; completed pages were kept',
    failed: '"{title}" generation failed'
  },
  rendererErrorBoundary: {
    title: 'The page ran into a problem',
    description: 'This page cannot continue. Refresh the app to recover.',
    refresh: 'Refresh app'
  },
  templateDialog: {
  ...
  templates: {
    ...
    layoutLibraryTitle: 'Layout library',
    layoutLibraryCount: '{count} layouts',
    layoutLibraryHint:
      'When you import a PPTX template, parametrizable pages are harvested automatically into the layout library with content-slot contracts (title / list / metric / media slots and capacity) for locked-mode generation and layout switching.',
    layoutLibraryExpand: 'Expand',
    layoutLibraryCollapse: 'Collapse',
    layoutLibraryColTitle: 'Page',
    layoutLibraryColRoles: 'Roles',
    layoutLibraryColSlots: 'Slots',
    layoutLibraryColCapacity: 'Modules',
    layoutLibrarySlotTitle: 'Title',
    layoutLibrarySlotList: 'List',
    layoutLibrarySlotMedia: 'Media',
    layoutLibrarySlotText: 'Text',
    layoutLibraryDelete: 'Delete layout',
    layoutLibraryDeleted: 'Layout deleted',
    layoutLibraryDeleteFailed: 'Failed to delete layout',
    layoutLibraryLoadFailed: 'Failed to load layout library',
    refresh: 'Refresh',
  ...
  settings: {
    ...
    themePlaceholder: 'Select an app theme',
    themeSage: 'Natural Sage',
    themeSageDescription: 'Soft natural greens and warm surfaces for long creative sessions.',
    themeStudio: 'Calm Studio',
    themeStudioDescription: 'Clear neutral surfaces with teal accents for focused editing.',
    themeCoral: 'Warm Coral',
    themeCoralDescription:
      'Creamy warm surfaces with coral and clay accents for an inviting creative workspace.',
    themePastel: 'Soft Pastel',
    themePastelDescription:
      'Soft rose with butter yellow, mint, and lilac accents for a light creative workspace.',
    themeMidnight: 'Midnight Desk',
    themeMidnightDescription: 'A low-luminance workspace designed for evening use.',
    themeUpdated: 'Theme style updated',
    themeSaveFailed: 'Failed to save theme style',
    generalTab: 'General',
    modelTab: 'Base model configuration',
    imageModelTab: 'Image models',
    layoutRulesTab: 'PPT rules',
    advancedTab: 'Advanced',
    layoutProfileTitle: 'Layout rules',
    layoutDirectionTitle: 'PPT composition direction',
    layoutDirectionHint:
      'Set the composition boundaries first, then let AI select a Pattern from the content relationship. The current style still owns color and visual treatment.',
    layoutEnabled: 'Enable rules',
    layoutPreset: 'Presentation type',
    layoutPresetProfessional: 'Professional',
    layoutPresetConsulting: 'Consulting',
    layoutPresetKeynote: 'Keynote',
    layoutPresetTeaching: 'Teaching',
    layoutPresetCustom: 'Custom',
    layoutDensity: 'Content density',
    layoutDensitySpacious: 'Spacious',
    layoutDensityBalanced: 'Balanced',
    layoutDensityCompact: 'Compact',
    layoutCompositionMode: 'Composition mode',
    layoutCompositionNative: 'Professional PPT (recommended)',
    layoutCompositionBalanced: 'Balanced PPT and modules',
    layoutCompositionFreeform: 'Freeform',
    layoutModuleStyle: 'Content module treatment',
    layoutModuleFlat: 'Flat zones',
    layoutModulePanels: 'Light panels',
    layoutModuleAdaptive: 'Adaptive (recommended)',
    layoutCardUsage: 'Card usage',
    layoutCardsMinimal: 'Minimal',
    layoutCardsLimited: 'Limited',
    layoutCardsFlexible: 'As needed',
    layoutWhitespace: 'Whitespace',
    layoutWhitespaceGenerous: 'Generous',
    layoutWhitespaceBalanced: 'Balanced',
    layoutWhitespaceCompact: 'Compact',
    layoutMaxBlocks: 'Primary content blocks (2-6)',
    layoutHeroPercent: 'Minimum main visual share (30%-70%)',
    layoutForbidDashboard: 'Forbid dashboard layouts without real dashboard content',
    layoutForbidUiChrome: 'Forbid buttons, badges, navigation, and other web UI chrome',
    layoutVaryLayouts: 'Vary composition rhythm across consecutive slides',
    layoutVaryTitlePlacement: 'Allow title placement to follow the slide rhythm',
    layoutAllowSideBySide: 'Allow side-by-side layouts for real comparisons',
    layoutSafeAreaTitle: 'Canvas safe area and type',
    layoutCanvasHint:
      'Canvas size is still selected when creating a presentation. These values protect readable content; backgrounds, full-bleed images, and decoration may extend to the edges.',
    layoutSafeHorizontal: 'Left and right safe margin',
    layoutSafeVertical: 'Top and bottom safe margin',
    layoutSafeAreaPreview: 'Readable content area',
    layoutSafeAreaPreviewHint: '16:9 safe-area preview',
    layoutTypographyTitle: '16:9 typography baseline',
    layoutDeckTitleSize: 'Cover title',
    layoutSlideTitleSize: 'Slide title',
    layoutSlideSubtitleSize: 'Slide subtitle / lead',
    layoutModuleTitleSize: 'Module second-level title',
    layoutCardTitleSize: 'Card / subheading',
    layoutBodySize: 'Body text',
    layoutEmphasisSize: 'Key metric / phrase',
    layoutAuxiliarySize: 'Notes / sources',
    layoutTypographyHint:
      'Targets are based on a 1600×900 canvas. 4:3, portrait, and square canvases scale them by height. Shorten copy or change layout before shrinking type.',
    layoutCardSystemTitle: 'Cards, spacing, and takeaway',
    layoutCardAlignment: 'Card text alignment',
    layoutAlignmentAdaptive: 'Adaptive (recommended)',
    layoutAlignmentLeft: 'Always left',
    layoutAlignmentCenter: 'Always centered',
    layoutSummaryMode: 'Slide takeaway line',
    layoutSummaryContextual: 'Decide by slide content',
    layoutSummaryAlways: 'Add on normal content slides',
    layoutSummaryOff: 'Do not add automatically',
    layoutSubtitleMode: 'Slide subtitle',
    layoutSubtitleOn: 'Allow subtitles',
    layoutSubtitleContentOff: 'Off on content slides, keep on cover/section pages',
    layoutSubtitleOff: 'Off on all slides',
    layoutMaxCards: 'Peer card limit',
    layoutUnitCards: 'cards',
    layoutCardPadding: 'Card padding',
    layoutCardGap: 'Gap between cards',
    layoutTitleContentGap: 'Title-to-content gap',
    layoutSectionGap: 'Primary section gap',
    layoutModuleGap: 'Peer module gap',
    layoutModulePadding: 'Bounded module inset',
    layoutPatternTitle: 'PPT Pattern library',
    layoutPatternHint:
      'AI identifies the narrative job first, then selects one whole-slide Pattern. Adjacent pages avoid repeating the same silhouette.',
    layoutStaircaseTitle: 'Staircase strip parameters',
    layoutStaircaseOffset: 'Horizontal offset per strip',
    layoutIconBoxSize: 'Icon / number zone',
    layoutModuleTitleBodyGap: 'Module title-to-body gap',
    layoutStaircaseHint:
      'Use staircase strips for 3–5 ordered, progressive, or hierarchical points. Each strip contains an icon/number, a module title, and 1–2 body lines.',
    layoutDecorateCardIcons: 'Allow gradients or circular backings for useful icons',
    layoutAllowCardPills: 'Allow 2–3 short pills per card',
    layoutImagePlaceholders: 'Create replaceable semantic placeholders for missing images',
    layoutCardStyleHint:
      'This controls card structure and usage. Colors, radii, shadows, and icon gradients still come from the selected style template.',
    layoutExpertTitle: 'Expert Markdown editor',
    layoutExpertPlaceholder:
      '## My layout principles\n\n- One core assertion per slide\n- Lead data slides with the conclusion\n- Avoid decorative card containers',
    layoutExpertHint: 'These rules are injected into subsequent generation and editing agents.',
    layoutRestoreDefaults: 'Restore defaults',
    layoutSave: 'Save rules',
    layoutSaved: 'Layout rules saved',
    layoutSavedDescription: 'Future generation, retries, and AI edits will use these rules.',
    layoutSaveFailed: 'Failed to save layout rules',
    layoutDefaultsRestored: 'Defaults restored. Save to apply.',
    ...
    imageModelUsageHint:
      'When AI visuals are enabled, images are generated only for slides with image slots. Otherwise, or if generation fails, a replaceable placeholder is used.',
    ...
    apiKeyPreserveHint:
      'When editing an existing model, leave this blank to keep the saved API key. New models require a key.',
    imageModelCredentialHint:
      'Sensitive fields are not shown again. Omit them when editing to keep saved values, or enter them to replace.',
    ...
    verifyPassed: 'Model connection verified',
    verifyPassedDescription: 'The current configuration can call the model',
    verifyFailed: 'Model connection verification failed',
...
- [Flickering or shaking animations that disturb presenting]`
  ...
  sessionDetail: {
    ...
    backToSessions: 'Back to sessions',
    loadFailedTitle: 'Session failed to load',
    loadFailedDescription:
      'The session data could not be read. Retry or return to the session list.',
    loadingDescription: 'Preparing the session content. Please wait.',
    invalidSessionTitle: 'Session not found',
    invalidSessionDescription: 'This session may have been deleted or the link may have expired.',
    missingSlideSizeTitle: 'Slide size is missing',
    missingSlideSizeDescription: 'This session has no valid slide size, so the editor cannot open.',
    retrySessionLoad: 'Retry loading',
    previewLoadFailed: 'Preview failed to load',
    retryPreview: 'Retry preview',
    htmlEditorLoadFailed: 'Editor canvas failed to load',
    retryHtmlEditor: 'Retry loading',
    restoreStateFailed: 'Could not restore the session runtime state. Please retry.',
    ...
    toolbarExportVideoUnavailable: 'MP4 export is unavailable',
    toolbarExportVideoUnavailableFfmpeg: 'FFmpeg is missing. Reinstall or repackage the app.',
    toolbarExportVideoUnavailableCheck: 'Could not check FFmpeg. Please try again later.',
    ...
    manualPromptSeparator: ', ',
    manualAddElements: 'Added {count} element(s)',
    manualDeleteElements: 'Deleted {count} element(s)',
    manualMoveElements: 'Adjusted the position of {count} element(s)',
    manualEditText: 'Edited text in {count} element(s)',
    manualEditProperties: 'Edited properties of {count} element(s)',
  ...
  fonts: {
    ...
    uploadDialogDescription:
      'Supports .woff2, .ttf, and .otf. You can set different weights and styles for each file. Use TTC collections as system fonts.',
    ...
    selectFile: 'Please select .woff2, .ttf, or .otf font files',
    ...
    schemeAutoName: 'Auto match',
    schemeAutoHint: 'The agent picks fonts by topic and language',
    schemeAutoSummary: 'Auto-match topic and content language',
    schemeMissingTitle: 'Missing fonts: {families}',
    schemeMissing: 'Missing: {families}',
    schemeCustom: 'Custom three-level fonts',
    schemeRoleTitle: 'Headline',
    schemeRoleSubtitle: 'Subtitle',
    schemeRoleBody: 'Body',
    schemeSelectPlaceholder: 'Select {role}',
    schemeManage: 'Manage fonts & schemes',
    schemeCardTitle: 'Font schemes',
    schemeCardDesc: 'Five built-in pairings plus your custom three-level schemes',
    schemeCreate: 'New scheme',
    schemeCreateTitle: 'Create font scheme',
    schemeEditTitle: 'Edit font scheme',
    schemeDialogDescription:
      'Pick a reusable set of headline, subtitle, and body fonts for your deck.',
    schemeNamePlaceholder: 'Scheme name',
    schemeDescriptionPlaceholder: 'Usage notes (optional)',
    schemeSave: 'Save scheme',
    schemeFillRequired: 'Fill in the scheme name and pick headline, subtitle, and body fonts',
    schemeSaved: 'Font scheme saved',
    schemeSaveFailed: 'Failed to save font scheme',
    schemeDeleted: 'Font scheme deleted',
    schemeDeleteFailed: 'Failed to delete font scheme',
    schemeDeleteLabel: 'Delete scheme {name}',
    schemeBuiltInTag: 'Built-in',
    schemeCustomTag: 'Custom',
    schemeMissingTag: 'Missing fonts',
    roleAllLevels: 'All levels',
    editFontTitle: 'Edit font info',
    editFontDescription:
      'Update the display name, usage, and script coverage without touching font files.',
    saveChanges: 'Save changes',
    fontUpdated: 'Font info updated',
    fontUpdateFailed: 'Failed to update font info',
    systemFontsTitle: 'Local system fonts',
    systemFontsDesc: 'References installed system fonts only; files are never copied or bundled.',
    editFontLabel: 'Edit {family}'
  },
  thinking: {
    ...
    storageRequiredTitle: 'Choose a project storage folder first',
    storageRequiredDescription:
      'Chats, uploaded sources, and generated files are stored in the local folder you choose. A new chat will open after it is saved.',
    chooseStorageAndCreate: 'Choose folder and start chat',
    storageSetupFailed: 'Failed to set storage folder',
    storageReady: 'Storage folder configured',
    ...
    activityLog: 'Work log',
    activityCompleted: 'Done',
    activityRetrying: 'Retrying',
    activityFailed: 'Failed',
    connectionConnecting: 'Connecting',
    connectionConnected: 'Connected',
    connectionRetrying: 'Reconnecting',
    connectionDisconnected: 'Disconnected',
    replyFailedTitle: 'This task did not complete',
    retry: 'Retry',
    ...
    outlineView: 'Outline',
    outlineListView: 'List view',
    outlineGridView: 'Card view',
    editPageOutlineTitle: 'Edit page {page} outline',
